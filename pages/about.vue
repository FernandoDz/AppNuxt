                ...
                <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
                    <div class="mt-10 lg:mt-0">
                        ...
                        <p class="mb-5 text-base text-body-color dark:text-dark-6">
                            Our homes are one of the most valued investments an individual makes in their lifetime. Homes
                            provide shelter, security, and comfort. It is often one’s greatest asset as we spend most of our
                            time in our homes.
                        </p>
                        <p class="mb-8 text-base text-body-color dark:text-dark-6">
                            As with any other asset, it is instinctive to find the best ways to protect your asset. One way
                            of protecting our homes is by installing high-quality gutters that complement the home’s
                            architecture and protect it from damage caused by water accessing points of the home and causing
                            damage.
                        </p>
