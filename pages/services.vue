    ...
    <div id="services" class="section relative pt-20 pb-8 md:pt-16 md:pb-0 bg-white">
        <div class="container xl:max-w-6xl mx-auto px-4">
            ...
            <header class="text-center mx-auto mb-12 lg:px-20">
                <h2 class="text-2xl leading-normal mb-2 font-bold text-black mt-5">What We Do</h2>
                ...
                <p class="text-gray-500 leading-relaxed font-light text-xl mx-auto pb-2"> Gutter installation charlote NC
                </p>
            </header>
            <!-- End heading -->
            <!-- row -->
            <div class="flex flex-wrap flex-row -mx-4 text-center">
                <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp"
                    ...
                    <div
                        ...
                        <h3 class="text-lg leading-normal mb-2 font-semibold text-black">Installation</h3>
                        <p class="text-gray-500">Gutter installation may seem like a simple task, but can actually be a bit
                            of a challenge to
                            someone who has no experience</p>
                    </div>
                    <!-- end service block -->
                </div>
                <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp"
                    ...
                    <div
                        ...
                        <h3 class="text-lg leading-normal mb-2 font-semibold text-black"> Cleaning services</h3>
                        <p class="text-gray-500">Gutters are made to last. They are built to withstand different weather
                            conditions be it rainfall, stormy weather, or heavy snowfall.</p>
                    </div>
                    <!-- end service block -->
                </div>
                <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp"
                    ...
                    <div
                        ...
                        <h3 class="text-lg leading-normal mb-2 font-semibold text-black"> Gutter Guards</h3>
                        <p class="text-gray-500"> There is no denying that gutters play an important role in keeping our
                            homes safe by routing
                            water from and channeling it safely away from our homes.</p>
                    </div>
                    <!-- end service block -->
                </div>
                <!-- <div class="flex-shrink px-4 max-w-full w-full sm:w-1/2 lg:w-1/3 lg:px-6 wow fadeInUp"
